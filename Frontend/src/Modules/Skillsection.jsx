...
import { SiPostman, SiNextdotjs, SiJavascript, SiTailwindcss, SiExpress, SiMysql, SiMongodb, SiFigma } from "react-icons/si";
  ...
  const skills = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "Express.js", icon: <SiExpress />, color: "bg-gray-700 text-white" },
      ],
    ...
    },
{
  ...
  technologies: [
    ...
    { name: "Canva", icon: <img src={Canva} alt="Canva" className="w-4 h-4" />, color: "bg-gray-700 text-white" },
